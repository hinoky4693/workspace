    ...
    <head>
        ...
        $(function() {
				...
				$("#my_modify").click(function() {
					...
					$("#my_form").attr("action","<%=request.getContextPath()%>/BoardServlet");
					$("#my_form").submit();
				})
				...
				$("#my_select").click(function() {
					//$("#pagecode").val("B001");
					//$("#my_form").attr("method","post");
					//$("#my_form").attr("action","/BoardServlet");
					//$("#my_form").submit();
...
<form name="my_form" id="my_form">
 <table border="1" width="100%">                                 
                          <tr>
        <th width="20%">글번호</th>
        <td width="80%"><input type="hidden" name="seq" size="60"  value=<%=bvo.getSeq()%>><%=bvo.getSeq()%></td>
  </tr>
  <tr>
        <th>작성자</th>
        <td><input type="hidden" name="regid" size="60"  value="<%=bvo.getRegid()%>"><%=bvo.getRegid()%></td>
  </tr>
  <tr>
        <th>작성일</th>
        <td><input type="hidden" name="regdate" size="60"  value="<%=bvo.getRegdate()%>"><%=bvo.getRegdate()%></td>
  </tr>
  <tr>
        <th>제목</th>
  ...
  <tr>
  	<td colspan=2 align="center">
  		...
  		<a id="my_modify" class="btn btn-primary btn-block">수정</a>
  		
  		<a id="my_delete" class="btn btn-primary btn-block">삭제</a>
  		
  		<a id="my_select" class="btn btn-primary btn-block">목록</a>
  	</td>
  </tr>
</table>
</form>
