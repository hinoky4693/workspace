...
<body>
 	<form name="loginForm" id="loginForm" method="post"> method action <br>
 		hidden:<input type="hidden" 	name="seq" 	 	id="seq" 	class="seq"		value="12345"><br>
  		...
  		<input type="button"	name="regbtn"	id="regbtn"	class="regbtn"	value="가입"><br>
 	</form>

	<p id="PTAG_ID">Not loaded yet.</p> <br><br> <!-- id : 고유해야 한다. -->
	
	<p id="PTAG_ID_11" class="PTAG_CLASS">aaaaa</p><br>			 <!-- class: 일괄 적용시켜야 할 경우 사용 -->
	<p id="PTAG_ID_22" class="PTAG_CLASS">bbbbb</p><br>
	

	<!-- Java 호출
	import webapp.js.all
	lec_script ls = new lecscript();
	ls.myprint(5,3);
 	-->
